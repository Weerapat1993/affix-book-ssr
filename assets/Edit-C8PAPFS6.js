...
const EditProductForm = ({ initialValues }) => {
  const { data, patch, reset, setData, processing, errors, recentlySuccessful } = useForm(initialValues);
  const submit = (e) => {
    e.preventDefault();
    patch(route("products.update", data.id));
  };
  return /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "mt-6 space-y-6", children: [
    /* @__PURE__ */ jsx("input", { className: "hidden", name: "id", value: initialValues.id }),
    /* @__PURE__ */ jsx(
      FormInput,
      {
        label: "Name",
...
const EditProductForm$1 = EditProductForm;
function ProductEdit({ auth, product }) {
  return /* @__PURE__ */ jsxs(
    Authenticated,
    {
      user: auth.user,
      header: /* @__PURE__ */ jsx("h2", { className: "font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight", children: "Edit Product" }),
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-12", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto sm:px-6 lg:px-8", children: /* @__PURE__ */ jsx(EditProductForm$1, { initialValues: product }) }) })
      ]
    }
  );
}
