...
import { k as getNotificationList } from "../ssr.js";
...
const LayoutBreadcrumb = (props) => {
  const { list } = props;
  return list.length ? /* @__PURE__ */ jsx("div", { className: "flex bg-secondary items-center h-16 shadow", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto sm:px-6 px-2 lg:px-8 my-4 w-full", children: /* @__PURE__ */ jsx(Breadcrumb, { children: /* @__PURE__ */ jsx(BreadcrumbList, { children: list.map((item) => item.isLast ? /* @__PURE__ */ jsx(
    BreadcrumbItem,
    {
      className: "w-[200px] whitespace-nowrap overflow-hidden text-ellipsis",
      children: /* @__PURE__ */ jsx(BreadcrumbPage, { children: item.title })
    },
    item.key
    ...
    !item.isLinkLast && /* @__PURE__ */ jsx(BreadcrumbSeparator, {})
  ] }, item.key)) }) }) }) }) : null;
};
export {
  FooterLayout$1 as F,
  HamburgerMenuDrawer$1 as H,
  LayoutBreadcrumb as L,
