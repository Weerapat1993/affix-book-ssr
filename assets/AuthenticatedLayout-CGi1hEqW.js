...
import { A as ApplicationLogo } from "./ApplicationLogo-C5KpUhqt.js";
import { Link } from "@inertiajs/react";
import { u as usePermission, N as NotificationButton, H as HamburgerMenuDrawer, F as FooterLayout } from "./FooterLayout-DpFvbPph.js";
...
const LayoutBreadcrumb = (props) => {
  const { list } = props;
  return list.length ? /* @__PURE__ */ jsx("div", { className: "flex bg-secondary items-center h-16 shadow", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto sm:px-6 lg:px-8 my-4 w-full", children: /* @__PURE__ */ jsx(Breadcrumb, { children: /* @__PURE__ */ jsx(BreadcrumbList, { children: list.map((item) => item.isLast ? /* @__PURE__ */ jsx(BreadcrumbItem, { children: /* @__PURE__ */ jsx(BreadcrumbPage, { children: item.title }) }, item.key) : /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(BreadcrumbItem, { children: /* @__PURE__ */ jsx(Link, { href: item.href, children: /* @__PURE__ */ jsx(BreadcrumbLink, { children: item.title }) }) }, item.key),
