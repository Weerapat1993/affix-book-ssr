...
import { d as getBookFollowing, e as clickFollowing } from "../ssr.js";
import { a as useAppSelector, b as useAppDispatch, u as usePermission } from "./FooterLayout-fQGOwEQH.js";
...
const BookHeader = ({ book, isSuggest }) => {
  ...
  return /* @__PURE__ */ jsx("div", { style: { borderRadius: 10 }, className: "bg-slate-700 p-4", children: /* @__PURE__ */ jsxs(Row, { gutter: [16, 16], children: [
