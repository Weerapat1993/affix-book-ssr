...
const AdminHeader = () => {
  return /* @__PURE__ */ jsxs(Card, { children: [
    ...
    /* @__PURE__ */ jsxs(Flex, { wrap: true, gap: "small", children: [
      /* @__PURE__ */ jsx(Link, { href: route("admin.index"), children: /* @__PURE__ */ jsx(Button, { icon: /* @__PURE__ */ jsx(HomeOutlined, {}), type: "default", children: "Admin Home" }) }),
      /* @__PURE__ */ jsx("a", { href: "/admin", target: "_blank", rel: "noreferrer", children: /* @__PURE__ */ jsx(Button, { icon: /* @__PURE__ */ jsx(TeamOutlined, {}), type: "default", children: "Admin Page" }) }),
