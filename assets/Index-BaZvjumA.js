...
import { C as CardHeader, A as AdminHeader } from "./AdminHeader-ExHnE0gF.js";
...
import { u as usePermission } from "./FooterLayout-BaEYPs1Z.js";
import "react";
...
const ExcelDataImportButton = () => {
  ...
  const { handleFileUpload, data: responseData, contextHolder, beforeUpload } = useUploadFile("/a/excel");
