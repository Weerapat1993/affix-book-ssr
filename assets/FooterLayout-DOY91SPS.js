...
import { i as getNotificationList } from "../ssr.js";
  ...
  return /* @__PURE__ */ jsx(
    Dropdown,
    {
      ...
      dropdownRender: (menu) => /* @__PURE__ */ jsxs("div", { style: contentStyle, children: [
        items.length ? React.cloneElement(menu) : /* @__PURE__ */ jsx("div", { style: { paddingTop: 30 }, children: /* @__PURE__ */ jsx(Empty, { image: Empty.PRESENTED_IMAGE_SIMPLE }) }),
...
const FooterLayout = () => {
  return /* @__PURE__ */ jsxs("footer", { className: "max-w-7xl mx-auto px-2 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsx(Divider, {}),
    /* @__PURE__ */ jsxs(Row, { children: [
      /* @__PURE__ */ jsx(Col, { flex: 6 }),
      /* @__PURE__ */ jsx(Col, { className: "text-center", flex: 12, children: "© Copyright 2024. Created by Affix" }),
      /* @__PURE__ */ jsx(Col, { flex: 6, children: /* @__PURE__ */ jsx(Flex, { justify: "end", wrap: true, gap: "small", children: /* @__PURE__ */ jsx(Link, { href: route("about"), children: /* @__PURE__ */ jsx(Button, { size: "small", type: "text", children: "About Us" }) }) }) })
    ] })
  ] });
};
